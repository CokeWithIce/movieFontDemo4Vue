...
export default {
  ...
  methods:{
    ...
    changeUserPassword:function(event){
      axios.post("http://localhost:3000/users/findPassword",{username:this.username,userMail:this.userMail,userPhone:this.userPhone,repassword:this.repassword}).then((data)=>{
